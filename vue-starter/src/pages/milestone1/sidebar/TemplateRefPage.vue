<template>
    <div>
        ...
        <hr>
        <el-input label="Name" ref="nameRef" v-model="name" style="width:200px" placeholder="Enter Name" />
        <hr>
        <div>
            ...
            <div>
                ...
                >
                    <el-form-item label="First Name" prop="firstName">
                        <el-input type="text" v-model="formRule.firstName" class="w-auto" />
                    </el-form-item>
                    <el-form-item label="Last name" prop="lastName">
                        <el-input type="text" v-model="formRule.lastName" class="w-auto" />
                    </el-form-item>
                    <el-form-item label="Email" prop="email">
                        <el-input type="email" v-model="formRule.email" class="w-auto" />
                    </el-form-item>
                    <el-form-item label="Password" prop="password">
                        <el-input type="password" v-model="formRule.password" class="w-auto" />
                    </el-form-item>
                    <el-form-item label="Confirm Password" prop="confirmPassword">
                        <el-input type="password" v-model="formRule.confirmPassword" class="w-auto" />
                    </el-form-item>
                    ...
                    <el-form-item label="Programming Languages" prop="languages">
...
export default {
    setup(){
        ...
        const validateDob = (rule,value,callback) => {          
            let age = Math.floor((new Date() - new Date(value).getTime()) / 3.15576e+10)
            if(age<18){
        ...
        let rules= reactive({
            firstName: [
                {required: true, message:'Please input fitst name', trigger:'blur'},
                {min:3, message:'Please enter minimum 3 characters', trigger:'blur'}
            ],
            lastName: [
